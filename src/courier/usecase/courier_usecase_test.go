...
//    mock_courier "yandex-team.ru/bstask/courier/repository/mocks"
//    "yandex-team.ru/bstask/model"
//)
//
////mock_courier "yandex-team.ru/bstask/courier/mocks"
//func TestGetCouriers(t *testing.T) {
//    ctl := gomock.NewController(t)
//    defer ctl.Finish()
//
//    repo := mock_courier.NewMockRepository(ctl)
//
...
//
//    service := usecase.NewCourierUsecase(repo)
